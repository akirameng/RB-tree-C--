// asssign4.cpp : Defines the entry point for the console application.
...

{
   ...
   part1();
	...
	//test.insert(5);
	//test.insert(12);
	//cout<<test.b_height()<<test.height();
	//test.debugPrint();
 // cout << endl << endl;
 //   
	//test.insert(3);
